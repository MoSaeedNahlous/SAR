import {
    ...
    ADD_CUSTOMER_FAIL, ADD_CUSTOMER_REQUEST, ADD_CUSTOMER_RESET, ADD_CUSTOMER_SUCCESS,
    DELETE_CUSTOMER_REQUEST, DELETE_CUSTOMER_SUCCESS, DELETE_CUSTOMER_FAIL,
    DELETE_CUSTOMER_RESET, UPDATE_CUSTOMER_REQUEST, UPDATE_CUSTOMER_SUCCESS
    , UPDATE_CUSTOMER_FAIL, UPDATE_CUSTOMER_RESET, BLOCK_CUSTOMER_REQUEST, BLOCK_CUSTOMER_SUCCESS, BLOCK_CUSTOMER_FAIL, BLOCK_CUSTOMER_RESET, UNBLOCK_CUSTOMER_REQUEST, UNBLOCK_CUSTOMER_SUCCESS, UNBLOCK_CUSTOMER_FAIL, UNBLOCK_CUSTOMER_RESET,
...
export const setCurrentCustomerReducer = (state = { currentCustomer: {} }, action) => {
     switch (action.type) {
